		...
		<div class='article-header-box'>
			...
			<!-- 标题 -->
				<div class='article-titlie-box'>
					...
					<h1 class="title-article"><?php echo $data[0][1]; ?></h1>
				</div>
			<!-- 阅读量 -->
		...
		<div style='padding-top:16px;'>
			<section>
				...
				<div id='dai_ma' style="height:auto;">
					...
					<p style='color: red;font-size: 25px;font-weight: 400;padding:30px;text-align:center;line-height: 30px;'><?php echo $data[0][2]; ?>
					</p>

					<p style='color: rgb(62, 62, 62);font-size: 15px;font-weight: 400;padding:80px;'><?php echo $data[0][0]; ?></p>
				</div>

			</section>
			<section>
				<p style='font-size:20px;color:red;padding: 10px;'></p>
				<div id='tu'>
					<li>上一篇：<a href="second_xq?id=<?php echo $id-1;?>" style='color:red;'><?php echo $back[0][1];?></a></li>	
					<li>下一篇：<a href="second_xq?id=<?php echo $id+1;?>" style='color:red;'><?php echo $forward[0][1];?></a></li>
				</div>
