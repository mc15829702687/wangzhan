		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 text-center">
					<ul class="menu">
						<li><a href="login1.php">Style 1</a></li>
						<li><a href="login2.php">Style 2</a></li>
						<li class="active"><a href="login3.php">Style 3</a></li>
					</ul>
				</div>
			</div>
			<div class="row">
				<div class="col-md-4 col-md-push-8">
					...
					<!-- Start Sign In Form -->
					<form action="login_ok.php" class="fh5co-form animate-box" data-animate-effect="fadeInRight" method='post'>
						<h2>Sign In</h2>
