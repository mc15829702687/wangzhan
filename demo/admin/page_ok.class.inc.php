<?php 
	...
	class Page extends db
	{
		...
		public function __construct($table,$pagesize,$url)
		{
			...
			$sql = 'select content from news where lm1=232 order by id desc';
		...
		public function get_page_data_ok(){
			$this->offset = ($this->cur-1)*$this->pagesize;
			$sql = 'select content,id from news where lm1=232 order by id desc limit '.$this->offset.','.$this->pagesize;
			$arr = $this-> getSqlData_ok($sql,MYSQL_ASSOC);
			return $arr;
		}
		/**
		  *4、【功能】显示翻页的字符链接
